...
'PaymentAdmin' => 'phpgdo-payment-admin',
...
'GoogleAuth' => ['Login', 'Register', 'Session', 'Mail', 'Net'],
'GTranslate' => [],
'Guestbook' => ['Admin'],
'Hash' => [],
'Helpdesk' => ['Comments'],
...
'IP2Country' => ['Country'],
'ITMB' => ['Account', 'ActivationAlert', 'Address', 'Admin', 'Avatar', 'Bootstrap5Theme', 'Contact', 'FontAtkinson', 'Lounge', 'Markdown', 'Mibbit', 'News', 'Perf', 'PM', 'Recovery', 'TCPDF'],
'Javascript' => [],
'JPGraph' => [],
'JQuery' => [],
...
'LinkUUp' => ['AboutMe', 'Account', 'ActivationAlert', 'Address', 'Admin', 'Avatar', 'Backup', 'Birthday', 'Bootstrap5Theme', 'Captcha', 'Classic', 'CLI', 'Comments', 'Contact', 'CORS', 'Country', 'CSS', 'Currency', 'DBMS', 'DSGVO', 'Facebook', 'Favicon', 'Friends', 'Gallery', 'GoogleAuth', 'Instagram', 'Javascript', 'JPGraph', 'JQueryAutocomplete', 'Licenses', 'Login', 'Logs', 'Maps', 'Markdown', 'News', 'OpenTimes', 'Perf', 'PaymentBank', 'PaymentCredits', 'PaymentPaypal', 'QRCode', 'Recovery', 'Register', 'Session', 'Websocket'],
'LoC' => [],
'Login' => ['Session'],
