...
'DSGVO' => ['Session'],
'EdwardSnowdenLand' => ['AboutMe', 'Account', 'ActivationAlert', 'Admin', 'Avatar', 'Bootstrap5Theme', 'Contact', 'Cronjob', 'IP2Country', 'Favicon', 'File', 'FontAwesome', 'Invite', 'JQueryAutocomplete', 'Mail', 'News', 'Register', 'Votes'],
'Facebook' => [],
'Favicon' => [],
'FFMpeg' => ['CLI'],
'File' => ['Session'],
