...
final class ModuleProviders
{
    ...
    public static function getGitUrl($moduleName, $which=1)
    {
        ...
        if (is_array($providers))
        {
            ...
            {
                throw new GDO_Exception("Invalid provider choice!");
            }
...
ptcha', 'BasicAuth', 'Profile', 'News', 'RandomOrg'],
    	...
    	'BananasGame2' => ['Bananas'],
    	'BananasGame21' => ['Bananas'],
    	...
    	'Bootstrap3' => ['JQuery'],
    	'Bootstrap5' => [],
    	'Bootstrap5Theme' => ['FontAwesome', 'Bootstrap5', 'Moment', 'JQueryAutocomplete'],
...
', 'Friends', 'Address', 'Maps', 'QRCode', 'Bootstrap5Theme', 'CORS', 'JPGraph', 'Markdown', 'News', 'ActivationAlert', 'Perf', 'Birthday', 'Website'],
    	'LoadOnClick' => [],
    	'Login' => ['Captcha'],
    	'LoginAs' => ['Login'],
    	'Logs' => [],
    	...
    	'Quotes' => ['Vote'],
    	'RandomOrg' => [],
    	'Ranzgruppe' => ['Account', 'Admin', 'Audio', 'Avatar', 'Backup', 'Captcha', 'Classic', 'Comment', 'Contact', 'Favicon', 'FontTitillium', 'Gallery', 'Guestbook', 'Invite', 'JQueryA
utocomplete', 'Login', 'Memberlist', 'News', 'Perf', 'Profile', 'Recovery', 'Register', 'User', 'Vote'],
    	'Recovery' => ['Captcha'],
    	'Register' => ['Cronjob'],
    	'Security' => [],
    	'Session' => [],
