...
final class ModuleProviders
{
	...
	public static $DEPENDENCIES = [
		...
		'KassiererCard' => ['Account', 'ActivationAlert', 'Address', 'Admin', 'Avatar', 'Birthday', 'Category', 'Contact', 'Classic', 'CountryRestrictions', 'CSS', 'FontAtkinson', 'FontAwesome', 'Invite', 'IP2Country', 'Javascript', 'JQueryAutocomplete', 'Licenses', 'Login', 'Maps', 'Mail', 'Maps', 'Markdown', 'News', 'PM', 'QRCode', 'Recovery', 'Register'],
		'Language' => [],
		'Licenses' => [],
		...
		'Math' => [],
		'Mettwitze' => ['BootstrapTheme', 'JQueryAutocomplete', 'Comment', 'Vote', 'Login', 'Register', 'Admin', 'Recovery', 'Account', 'Profile', 'Sitemap'],
		'Mibbit' => [],
		'Moment' => [],
		'Net' => [],
