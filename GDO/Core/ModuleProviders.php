...
final class ModuleProviders
{
	...
	public static $DEPENDENCIES = [
		...
		'KassiererCard' => ['Account', 'ActivationAlert', 'Address', 'Admin', 'Avatar', 'Backup', 'Birthday', 'Bootstrap5Theme', 'Category', 'Contact', 'Classic', 'CountryRestrictions', 'CSS', 'DoubleAccounts', 'FontAtkinson', 'FontAwesome', 'Invite', 'IP2Country', 'Javascript', 'JQueryAutocomplete', 'Licenses', 'Links', 'Login', 'Maps', 'Mail', 'Maps', 'Markdown','News', 'PM', 'QRCode', 'Recovery', 'Register'],
		'Language' => [],
		'Licenses' => [],
		...
		'Table' => [],
		'Tags' => [],
		'TBS' => ['Country', 'Language', 'Contact', 'Classic', 'Forum', 'News', 'Mibbit', 'OnlineUsers', 'Profile', 'PM', 'Login', 'Register', 'Recovery', 'Admin', 'Favicon', 'FontAwesome', 'Captcha', 'JQuery', 'JQueryAutocomplete', 'TBSBBMessage', 'LoadOnClick', 'Perf', 'Statistics', 'Python', 'Forum', 'LoginAs', 'File'],
		'Tests' => [],
		'Todo' => [],
		'TorDetection' => ['Net'],
		'UI' => [],
