...
final class ModuleProviders
{
	...
	public static $DEPENDENCIES = [
		...
		'KassiererCard' => ['Classic', 'JQueryAutocomplete', 'Javascript', 'CSS', 'QRCode', 'Account', 'Admin', 'Login', 'Register', 'Recovery', 'PM', 'Contact', 'Avatar', 'ActivationAlert', 'Invite', 'Birthday', 'PaymentCredits', 'PaymentPaypal'],
		'Language' => [],
		'Licenses' => [],
		'Links' => ['Votes', 'Tags', 'Cronjob'],
		'LinkUUp' => ['Account', 'Websocket', 'Comments', 'Login', 'Recovery', 'Register', 'Avatar', 'Gallery', 'Country', 'Admin', 'Contact', 'Facebook', 'Instagram', 'OpenTimes', 'Friends', 'Address', 'Maps', 'QRCode', 'Classic', 'CORS', 'JPGraph', 'Markdown', 'News', 'ActivationAlert', 'Perf', 'Birthday', 'Backup', 'Licenses', 'Currency', 'Mail', 'JQuery', 'JQueryAutocomplete'],
		'Login' => ['Session'],
		'Mail' => ['Mailer'],
		'Mailer' => ['Mail'],
		'Maps' => [],
