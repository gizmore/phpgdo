...
final class GDT_Path extends GDT_ComboBox
{
	...
	public function defaultLabel(): static { return $this->label('path'); }
...
// 	}
	...
	public function existingDir(): static
	{
		$this->existing = 'is_dir';
		return $this->icon('folder');
	}
	
	public function existingFile(): static
	{
	...
	public function completion(bool $completion=true): static
	{
