...
printf('|<b>%.02f&nbsp;MB</b>|<b>%d&nbsp;func</b> ', $i['memory_max']/(1024*1024), $i['funcCount']);
printf('|<i>%d&nbsp;Classes</i>|<i>%d&nbsp;gdoClasses</i>|<b><i>%d(%d)&nbsp;GDT</i></b>|<b><i>%d(%d)&nbsp;GDO</i></b>|<i>%d&nbsp;mod</i>|<i>%d&nbsp;langfs</i> ', $i['phpClasses'], $i['gdoFiles'], $i['gdtCount'], $i['gdtPeakCount'], $i['gdoCount'], $i['gdoPeakCount'], $i['gdoModules'], $i['gdoLangFiles']);
