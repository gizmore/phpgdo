...
printf('|<i>%d&nbsp;Classes</i>|<i>%d&nbsp;gdoClasses</i>|<b><i>%d(%d)&nbsp;GDT</i></b>|<b><i>%d&nbsp;GDO</i></b>|<i>%d&nbsp;mod</i>|<i>%d&nbsp;langfs</i> ', $i['phpClasses'], $i['gdoFiles'], $i['gdtCount'], $i['gdtPeakCount'], $i['gdoCount'], $i['gdoModules'], $i['gdoLangFiles']);
